...
describe('Private routes', () => {
    ...
    describe('POST /api/TODO/create', () => {
        ...
        it('should return 400 if description is empty', async () => {
            ...
            expect(response.body.error).toEqual('description is not allowed to be empty');
        });
        ...
        it('should return 400 if deadline is a text string', async () => {
            ...
            expect(response.body.error).toEqual('deadline must be in ISO 8601 date format');
        });
        ...
        it('should return 401 if token is invalid or null', async () => {
            ...
            expect(response.body.error).toEqual('Access denied. Token missing or invalid.');
        });
    });
    ...
    describe('PUT /api/TODO/edit', () => {
        ...
        it('should return 409 if new description is not unique', async () => {
            ...
            expect(response.body.error).toEqual('The new description must be unique.');
        });
        ...
        it('should return 400 if the new deadline is an invalid string', async () => {
            ...
            expect(response.body.error).toEqual('newDeadline must be in ISO 8601 date format');
        });
